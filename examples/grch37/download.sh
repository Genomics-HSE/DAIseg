...
tar -xjf data/ancestral/homo_sapiens_ancestor_GRCh37_e71.tar.bz2 -C data/ancestral --strip-components 1
...
zcat data/gaps/gap.txt.gz >data/gaps/gap.txt
...
# remove 'chr' prefix from chromosome names
sed -i -e 's/^chr//' data/1000g/20140520.strict_mask.chr22.bed
